// // var, let,const is the way to declare a variable in JavaScript. var is function scoped, while let and const are block scoped. const is used for variables that should not be reassigned, while let is used for variables that can be reassigned.
// // //Alright dude 😄
// // var, let, const are used to declare variables in JavaScript (not Java).
...
// Mostly used in modern JS

// ✅ 3️⃣ const
// 🔹 Example
// const x = 10;
// // x = 20; ❌ not allowed
// // const x = 30; ❌ not allowed (same scope)
// console.log(x); // 10
// 🔹 Features
